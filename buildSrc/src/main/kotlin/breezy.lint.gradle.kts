...
spotless {
    kotlin {
        ...
        targetExclude(
            "**/build/**/*.kt",
            // TODO:
            "src/main/java/org/breezyweather/common/source/LocationPreset.kt",
            "src/main/java/org/breezyweather/common/ui/composables/LocationPreferences.kt",
            "src/main/java/org/breezyweather/common/utils/ISO8601Utils.kt",
            ...
            "src/main/java/org/breezyweather/settings/SettingsManager.kt",
            "src/main/java/org/breezyweather/settings/activities/SettingsActivity.kt",
